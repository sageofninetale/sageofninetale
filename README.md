...
| Repo | What it's testing |
|---|---|
| **[rag-experiment](https://github.com/sageofninetale/rag-experiment)** | LlamaIndex + ChromaDB + HuggingFace embeddings, retrieval grounded in real documents instead of a model's memory |
| **[langgraph-experiment](https://github.com/sageofninetale/langgraph-experiment)** | Position-aware agent state machines, applied to football scouting reports as a proving ground |
| **[langchain-experiment](https://github.com/sageofninetale/langchain-experiment)** | Decompose, answer, synthesize, a research chain pattern that later shapes how Cascade AI's agents hand off work to each other |
